...
#csv_file = "/mnt/f/dummyData/sampleData_1000000.csv"  # Replace with your CSV file name
#csv_file = "/mnt/c/dummyData/small-sample-data-cassandra.csv"
...
for table in ["query_1_table", "query_2_table", "query_3_table", "query_4_table", "query_5_table", "query_6_table"]: 
    ...
    dsbulk_cmd = [
        ...
        "-url", csv_file_1,
        "-header", "false",
        "-delim", ",",  # Replace with the delimiter used in your CSV
        "-m", "0=hostname, 1=usage_type, 2=timestamp, 3=value"
        ]

    # Execute the DSBulk command
    try:
